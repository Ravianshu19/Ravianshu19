...
<p align="center">
  <a href="https://ravianshu19.github.io">
...
<table width="100%" border="0" cellpadding="10" cellspacing="5" style="border-collapse: collapse; border: none; border-spacing: 15px;">
  
  <!-- ROW 1: TERMINAL INITIALIZATION (WHOAMI) -->
  <tr>
    <td colspan="2" width="100%" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      <div align="left" style="font-family: monospace; color: #a855f7; font-size: 11px; margin-bottom: 8px; letter-spacing: 1px;">
...
• Model Context Protocol (MCP) Servers &amp; Tools
  ...
  <!-- ROW 2: ACTIVE MISSIONS & TECH MATRIX -->
  <tr>
    ...
    <td width="50%" valign="top" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      <div align="left" style="font-family: monospace; color: #a855f7; font-size: 10px; margin-bottom: 8px; letter-spacing: 1px;">
...
<b>System Status:</b> 🟢 STABLE
  ...
  <!-- ROW 3: SYSTEM ANALYTICS (STAT CARDS) -->
  <tr>
    <td colspan="2" width="100%" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      <div align="left" style="font-family: monospace; color: #a855f7; font-size: 11px; margin-bottom: 8px; letter-spacing: 1px;">
        [ANALYTICS // DATAPACKS]
      ...
      <div align="center">
        <!-- Stats Card Custom Styled (Transparent, Cyan title, Purple borders) -->
  ...
  <!-- ROW 4: ACTIVITY GRAPH & CONTRIBUTIONS (SNAKE) -->
  <tr>
    ...
    <td width="50%" valign="top" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      ...
      <div align="center">
        <!-- Activity Graph with custom neon lines -->
  ...
  <tr>
    <td colspan="2" width="100%" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      ...
      <table width="100%" border="0" style="border: none; font-family: 'Share Tech Mono', monospace; text-align: center; color: #cbd5e1; font-size: 13px;">
        <tr>
          <td width="33%" style="padding: 10px; background-color: #030408; border-radius: 6px; border: 1px stroke #1e293b;">
  ...
  <!-- ROW 6: SPOTIFY NOW PLAYING & SYSTEM ARCHITECTURE -->
  <tr>
    <!-- Left Column: Spotify Now Playing -->
    <td width="50%" valign="top" style="background-color: #05060c; border: 1px solid #1e293b; border-radius: 8px; padding: 15px;">
      <div align="left" style="font-family: monospace; color: #a855f7; font-size: 10px; margin-bottom: 8px; letter-spacing: 1px;">
      ...
      <div align="center" style="margin-top: 10px; margin-bottom: 10px;">
        <!-- Live-linked Spotify now-playing widget styled with theme overrides -->
...
<div align="center">
  <a href="mailto:ravianshu278@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-ravianshu278%40gmail.com-00F5FF?style=for-the-badge&logo=gmail&logoColor=black&labelColor=1e1b4b" alt="Gmail" style="margin-right: 8px;" />
  </a>
